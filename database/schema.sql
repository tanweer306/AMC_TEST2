-- Create customers table with all registration fields
...
-- Create customer_selected_companies table for many-to-many relationship
...
-- Create customer_references table for professional references
